...
export class CreateVideos1785539075266 implements MigrationInterface {
    name = 'CreateVideos1785539075266'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."videos_status_enum" AS ENUM('draft', 'processing', 'ready', 'failed')`);
        await queryRunner.query(`CREATE TABLE "videos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "public_id" character varying(16) NOT NULL, "title" character varying(255) NOT NULL, "channel_id" uuid NOT NULL, "status" "public"."videos_status_enum" NOT NULL DEFAULT 'draft', "source_key" character varying(512) NOT NULL, "thumbnail_key" character varying(512), "upload_id" character varying(255), "original_filename" character varying(255) NOT NULL, "content_type" character varying(127) NOT NULL, "size_bytes" bigint, "duration_seconds" numeric(10,3), "width" integer, "height" integer, "video_codec" character varying(64), "container_format" character varying(64), "processing_error" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_39a1f0fe7991162aace659078ec" UNIQUE ("public_id"), CONSTRAINT "PK_e4c86c0cf95aff16e9fb8220f6b" PRIMARY KEY ("id"))`);
